...
public class A_for {
	public static void main(String[] args) {
		 ...
		 * 
		 * - 조건식 : "반복문이 수행 될 조건"을 작성하는 구문
		 * 			조건식이 true일 경우 해당 반복을 실행
		 * 			조건식이 false가 되는 순간 반복문을 탈출
		 *			(초기식에 제시된 변수를 가지고 조건식을 정함)
		 *
		...
		*/
		...
		/*
		 * java.lang.Math 클래스에서 제공하는 random()메소드 호풀하면 매번 다른 랜덤값을 받을 수 있다.
		 * 
		 * Math.random() 호풀시 -> 0.0 ~ 0.9999999999999999사이의 랜던값을 반환
		 * 						0 <= ~ < 1.0
		 ...
		 * 
		 * int num = (int)Math.random() * (최대값(최대값+1) - 최소값)) + 최소값
		 */
...
//		System.out.println(Math.random());
		...
		*/
		...
		//사용자에게 문자를 입력받아 해당 문자열의 짝수자리 글자만 출력
		//문자열 입력 : hello
		//el
		 ...
		 * String str;
		 * 
		 * System.out.println("문자열 입력 : "); str = sc.next();
		 */
