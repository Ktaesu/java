...
public class SetRun {
	public static void main(String[] args) {
		...
		//String에 equals() -> "실제 담긴 문자열"을가지고 동등비교 진행해서 일치하면 true/일치하지 않으면 false
		...
		//동일객체 : 긱 객체마다 hashCode결과가 일치하고, equals메소드로 비교시 true가 나올 때
		...
		while(it.hasNext()) { //다음에 가죠올 값이 있니?
			Object obj = it.next();
			System.out.println(obj);
			
		}
		
		//3. ArrayList에 담아온 다음 그 ArrayList를 반복적으로 돌아가며 접근 방법
