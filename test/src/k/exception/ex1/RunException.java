...
public class RunException {
	...
	public void method02(){
		/*
		 * CheckdException : 반드시 예외처리를 해야되는 예외들
		 * => 조건문을 미리 제시할 수 없음(왜? 예측이 불가한 곳에서 문제가 발생하기 떄문에 예외처리가 필수)
		...
		//2. throw : 여기서 예외를 처리하지않고 현재 이 메소드를 호출한 곳으로 예외처리를 떠넘기겠다.
