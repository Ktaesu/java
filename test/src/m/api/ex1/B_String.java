...
//			
	...
	public void method02() {
		...
		//	문자열에서 전달받은 index 위치에 문서만을 추출해서 리턴
	...
	public void method03() {
		...
		//방법1. 분리된 문자열들을 Strig[] 배열에 차곡차곡 담고자 할때
		//		String클래스에서 제곡하는 split 메소드를 사용
		...
		//	Java.utill.StringTokenizer클래스를 이용
...
//		System.out.println(stn.countTokens()); // 더이상 토큰이 남아있지 않을 때 다음토큰을 가져오려고 하면 예외발생!
