...
public class Variable {
	/*
	 * 변수 : 값을 기록하고 사용하기위한 메로리 공간, 값을 보존하거나, 보관된 값을 가져와 사용할 수 있다.
	 * 
	 * [표현법] 자료형 변수이름;
	 * 
	 * 자료형 : 변수의 크기 및 모양을 저장해주는 부분
	...
	public static void main(String[] args) {
		...
		//실수형(소수점6자리까지) 자료형으로 저장할 수 있는 num2라는 이름의 변수를 만들어줘
		float num2;
		num2 = 3.141591f;
		 ...
		 * 모두 정수를 저장하는 자료형, 각 자료형마다 표현할 수 있는 수의 변위가 다르다.
		 */
		...
		String str3 = new String("안녕하십니까"); //객체생성방식으로 String변수를 선언
